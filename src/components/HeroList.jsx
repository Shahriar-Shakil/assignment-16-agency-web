...
async function getData() {
  ...
  if (!response.ok) {
    throw new Error("Error in HeroList");
  }
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="flex flex-wrap lg:mb-4 lg:ml-6">
                ...
                <div className="relative w-full md:w-1/2 lg:w-2/3 h-64 p-2 object-cover rounded-4xl lg:rounded-bl-none">
                  <Image
                    className=" p-2 object-cover rounded-4xl lg:rounded-br-none"
                    src={data.image2}
                    alt="img2"
              ...
              <div className="flex flex-wrap lg:mb-4 lg:mr-6">
                <div className="relative w-full md:w-1/2 lg:w-2/3 h-64 ">
                  <Image
                    className=" object-cover rounded-4xl lg:rounded-br-none p-2"
                    src={data.image3}
                    fill={true}
                    objectFit="cover"
                    alt="img3"
                ...
                <div className="relative w-full md:w-1/2 lg:w-1/3 h-64 ">
                  <Image
                    className=" p-2 object-cover rounded-4xl lg:rounded-bl-none"
                    src={data.image4}
                    alt=""
                    fill={true}
                    objectFit="cover"
